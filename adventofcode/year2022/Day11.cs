namespace adventofcode.year2022
{
    public class Day11 : Solution
    {
        ...
        {
            long DecreaseWorry(long x)
            {
                return x / 3L;
            }
            
            var game = new Game(_input, DecreaseWorry);
            ...
            var total = Convert.ToInt64(inspections[^1]) * Convert.ToInt64(inspections[^2]);
        ...
        public override string PartTwo()
        {
            ...
            {
                commonDenominator *= Convert.ToInt64(_input[i + 3].Trim().Substring("Test: divisible by ".Length));
            }
            
            long DecreaseWorry(long x)
            {
                return x % commonDenominator;
            }
